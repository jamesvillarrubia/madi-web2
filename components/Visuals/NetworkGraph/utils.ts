...
export function showLabel(this: SVGPathElement, event: MouseEvent, d: { id: number }, label: LabelSelection) {
...
export   function hideLabel(this: SVGPathElement, event: MouseEvent, d: { id: number }, label: LabelSelection) {
...
export function createNodes(
  ...
  export function createSimulation(nodes: any[], links: any[], width: number, height: number) {
    return d3
  ...
  export function createLinkElements(svg: d3.Selection<SVGSVGElement, unknown, null, undefined>, links: any[]) {
    return svg
      .append('g')
      .selectAll('line')
      .data(links)
  ...
  export function createLabelElements(svg: d3.Selection<SVGSVGElement, unknown, null, undefined>, nodes: any[]) {
    return svg
      .append('g')
      .attr('class', 'labels')
...
export function updateLinkPositions(linkElements: d3.Selection<SVGLineElement, unknown, null, undefined>) {
    linkElements
  ...
  export function updateNodePositions(nodeElements: d3.Selection<SVGPathElement, unknown, null, undefined>) {
    nodeElements.attr('transform', d => `translate(${d.x},${d.y})`);
  }
  
  export function updateLabelPositions(labelElements: d3.Selection<SVGForeignObjectElement, unknown, null, undefined>) {
    labelElements
      .attr('x', d => (d.x ?? 0) + 10)
      .attr('y', d => (d.y ?? 0) + 10);
  }